...
PSP_MODULE_INFO("NooDS PSP", 0, 1, 2);
...
int main() {
  ...
  psp_render = new Draw();
	...
	/*int res = load_module("me.prx", 0,0);
	if (res < 0) {
  ...
  //void* shr_mem_addr = (void*)0x1FC00000;

  /*core->gpu2D[0].framebuffer = reinterpret_cast<uint16_t*>((void*)(0x0A000000));
  core->gpu2D[1].framebuffer = reinterpret_cast<uint16_t*>((void*)(0x0A000000 + 256*192*2));*/
